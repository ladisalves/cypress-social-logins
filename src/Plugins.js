...
async function baseLoginConnect(
  ...
  const additionalHeaders = {'Accept-Language': 'en-USq=0.9,enq=0.8'}
  const extraHeaders = options.basicAuth
    ? Object.assign({}, additionalHeaders, {Authorization: `Basic ${options.basicAuth}`})
    : additionalHeaders
